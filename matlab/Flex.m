...
function ButtonDown(hObj,evnt)
  ...
  if ((pos(2) > 240-(28+36)) && (pos(2) < 240-28) && (pos(1) > 165) && (pos(1) < (165+42)))
            alarmswitchbutton=1;
  end
...
% background image 
  ...
  hax = axes('Units', 'pixels', 'Position', [1, 1, 320, 240], 'Visible', 'on');
  image(IM)
  axis off
...
%Update output ports
  ...
  block.OutputPort(7).Data = boolean(alarmswitchbutton);   % 8 for boolean, 0 for double, 3 for uint8 4 for int8
